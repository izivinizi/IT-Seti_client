<div align="center">
  ...
  <p>
    <a href="https://github.com/izivinizi/IT-Seti_client/releases/tag/v0.13.1"><b>Скачать предварительный выпуск 0.13.1</b></a>
  ...
  <p><b>Текущий предварительный выпуск: 0.13.1</b> · Windows 10/11 · x64</p>
</div>
...
![Пользовательское окно. Компьютер и идентификаторы на изображении демонстрационные](ITSeti.Maintenance/docs/images/user-home.png)

![Обзор инженерского режима. Идентификаторы на изображении демонстрационные](ITSeti.Maintenance/docs/images/admin-overview.png)
...
1. Откройте [предварительный выпуск 0.13.1](https://github.com/izivinizi/IT-Seti_client/releases/tag/v0.13.1) и скачайте `ITSeti-Maintenance-Setup.exe`.
...
**«Копировать всё»**. Подписи и значения находятся в одном поле: можно выделить
мышью весь блок целиком или отдельный фрагмент. Синяя кнопка копирует весь блок.
Адрес электронной почты копируется отдельно.
...
- Локальный вход открывает инженерский интерфейс в текущем процессе и с текущими
  правами пользователя. Этот вариант не повышает права Windows.

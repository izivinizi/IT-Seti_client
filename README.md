...
Обновление приложения и установка ПО ИТ-Сети запускаются через фиксированные
системные задачи, зарегистрированные установщиком; повторный ввод пароля не
нужен. Видимые окна сторонних утилит работают в сеансе текущего пользователя и
не получают повышение прав скрытым способом. Фоновая диагностика выполняется
системной задачей.
